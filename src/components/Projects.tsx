...
const projects = [
  {
    slug: "simppa",
    title: "Sistem Informasi Manajemen Pasca-perencanaan Aplikasi",
    shortDescription:
      "Developed a web-based Project Management Information System for PT Petrokimia Gresik to improve project visibility, change tracking, and collaboration between IT teams and stakeholders. Built with Laravel and PostgreSQL, the platform features project progress monitoring, dashboard analytics, master data management, and team information management, enabling more efficient and transparent application development processes.",
    description:
      "Developed a web-based Project Management Information System for PT Petrokimia Gresik to streamline project management processes and enhance collaboration between IT teams and business stakeholders. The application was designed to increase project visibility by providing centralized access to project information, enabling teams to monitor progress, track requirement changes, and manage development activities more efficiently throughout the project lifecycle. Built using Laravel and PostgreSQL, the system includes comprehensive features such as project progress monitoring, interactive dashboard analytics, master data management, and team information management. These capabilities allow users to gain real-time insights into project status, evaluate performance metrics, and maintain structured project documentation. The platform also supports transparent communication and coordinated decision-making by ensuring that project updates, change requests, and development activities are recorded and accessible to all relevant stakeholders. Through this solution, project execution became more organized, efficient, and measurable, helping improve the overall application development workflow within the organization.",
    tags: ["Laravel", "PostgreSQL", "HTML5", "PHP", "Bootstrap", "CSS3", "JavaScript", "Figma", "Laragon"],
