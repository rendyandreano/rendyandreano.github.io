...
const skills = [
  ...
  { name: "MySQL", level: 78, icon: Smartphone },
  { name: "Firebase", level: 80, icon: Cloud },
  { name: "REST API", level: 88, icon: Globe },
  { name: "Figma", level: 88, icon: Globe },
  { name: "Vite", level: 88, icon: Globe },
  { name: "HTML", level: 88, icon: Globe },
  { name: "React Native", level: 88, icon: Globe },
  { name: "Javascript", level: 88, icon: Globe },
  { name: "CSS", level: 88, icon: Globe },
  { name: "Trello", level: 88, icon: Globe },
  { name: "Electron.js", level: 88, icon: Globe },
